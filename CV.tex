...
软件学院 \quad 电子信息（人工智能方向） \quad 硕士（在读） 
\begin{itemize}[nosep]
    \item \textbf{所在实验室：} 交互数据分析团队 ZJUIDG（隶属于计算机辅助设计与图形系统 (CAD\&CG) 全国重点实验室）
\end{itemize}
...
计算机科学与技术 \quad 本科 
\begin{itemize}[nosep]
    \item \textbf{专业成绩：} GPA: 4.04/5.00，专业排名前25\%
    \item \textbf{主修课程：} 线性代数(94)、高等数学(92)、数据结构(89)、离散数学(88)、计算机网络(86)、人工智能导论(85)
\end{itemize}
